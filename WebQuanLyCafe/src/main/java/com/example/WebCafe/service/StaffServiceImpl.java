...
public class StaffServiceImpl implements StaffService {
	...
	@Override
	@Transactional
	public ProductResponse patchProduct(Integer productId, StaffProductPatchRequest request) {
		if (request.quantity() == null && request.available() == null) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Cần gửi quantity và/hoặc available");
		}
